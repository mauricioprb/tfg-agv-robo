...
class MQTTClient:
    ...
    def publicar(self, topico, mensagem):
        # Garante que a mensagem seja um JSON válido
        if isinstance(mensagem, dict):  # Se for dicionário, converte para JSON
            mensagem_json = json.dumps(mensagem)
        else:
            mensagem_json = mensagem  # Caso contrário, assume que já é JSON
